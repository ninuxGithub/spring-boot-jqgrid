...
public class UserController {
	...
	public @ResponseBody CustomGenericResponse edit(@RequestParam("id") Long id,
			@RequestParam("firstName") String firstName, @RequestParam("lastName") String lastName,
			@RequestParam("address") String address, @RequestParam("city") String city,
			@RequestParam("state") String state, @RequestParam("zipPostal") String zipPostal,
	...
	public @ResponseBody CustomGenericResponse add(@RequestParam("firstName") String firstName,
			...
			@RequestParam("zipPostal") String zipPostal, @RequestParam("phoneNumber") Long phoneNumber) {
	...
	public @ResponseBody CustomGenericResponse delete(@RequestParam("id") Long id) {
